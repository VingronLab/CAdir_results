...
dir <- "./results/"
imgdir <- file.path(dir, "img/biclustering/")
...
```{r}
fig <- (p_max_ce + p_max_ari_g + p_mean_ce + p_mean_ari_g) + plot_layout(guides = "collect") +
