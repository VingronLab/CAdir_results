...
p_ecs_std <- cluster_apl(
  ...
  geom_label(
    ...
    aes(x, y, text = NULL),
    label = "Vascular endothelial cell",
    color = "#d44a3d",
    hjust = 0
  ) +
  ggtitle("Endothelial_cell") +
  theme_bw(base_size = 16)
...
ggsave(
  plot = first_half_fig2,
  filename = file.path(imgdir, "fig2_1st_half.tiff"),
  width = 6372,
  height = 3312,
  units = "px"
)
...
ggsave(
  plot = second_half_fig2,
  filename = file.path(imgdir, "figure2_2ndhalf.tiff"),
  width = 5372,
  height = 3312,
  units = "px"
)
...
ggsave(
  plot = fig2,
  filename = file.path(imgdir, "figure2_patchwork_panel.tiff"),
  width = 6372,
  height = 3312,
  units = "px"
)
...
ggsave(
  plot = sfig1,
  filename = file.path(imgdir, "suppl_figure1_patchwork_panel.tiff"),
  width = 4802,
  height = 4502,
  units = "px"
)
