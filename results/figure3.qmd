...
pc_mod_lng <- plot_clusters_custom(
  cak,
  ca,
  show_genes = TRUE,
  label_genes = FALSE,
...
ggsave(
  plot = pc_mod_ng,
  file = file.path(imgdir, "plot_clusters_no_genes.pdf"),
  width = 3400,
  height = 2000,
  units = "px"
)
...
ggsave(
  plot = pc_mod_ng,
  file = file.path(imgdir, "plot_clusters_no_genes.png"),
  width = 3400,
  height = 2000,
  units = "px"
)
...
```{r}
pc_corr_list_no_genes <- plot_clusters(
  cak_corr,
  ca_corr,
  show_genes = TRUE,
  label_genes = FALSE,
...
pc_corr_no_genes <- wrap_plots(pc_corr_list_no_genes, ncol = 2, nrow = 3) +
  guide_area() +
  plot_layout(guides = "collect")

ggsave(
  plot = pc_corr_no_genes,
  file = file.path(imgdir, "apl_clusters_corrected_no_genes.pdf"),
  device = cairo_pdf,
  width = 3000,
  height = 2500,
  units = "px"
...
ggsave(
  plot = pc_corr_no_genes,
  file = file.path(imgdir, "apl_clusters_corrected_no_genes.png"),
  width = 3000,
  height = 2500,
  units = "px"
)
...
info$col <- col_picker[1:nrow(info)]
...
gr$gene_set <- stringr::str_wrap(gr$gene_set, width = 25)
...
ggsave(
  plot = fig3,
  filename = file.path(imgdir, "figure3_patchwork_panel.tiff"),
  height = 3600,
  width = 5000,
  units = "px"
)
...
ggsave(
  plot = suppl_fig2,
  filename = file.path(imgdir, "suppl_figure2_patchwork_panel.tiff"),
  height = 3600,
  width = 5000,
  units = "px"
)
