...
check_pcacomp <- function(object) {
  ...
  if (
    isTRUE(
      !is.empty(object@row_masses) &
        length(object@row_masses) != dim_rows
    )
  ) {
    msg <- paste0(
      "Length of row_masses is ",
  ...
  if (
    isTRUE(
      !is.empty(object@col_masses) &
        length(object@col_masses) != nrow(object@V)
    )
  ) {
    msg <- paste0(
      "Length of col_masses is ",
  ...
  if (
    isTRUE(
      !is.empty(object@row_inertia) &
        length(object@row_inertia) != dim_rows
    )
  ) {
    msg <- paste0(
      "Length of row_inertia is ",
  ...
  if (
    isTRUE(
      !is.empty(object@col_inertia) &
        length(object@col_inertia) != nrow(object@V)
    )
  ) {
    msg <- paste0(
      "Length of col_inertia is ",
  ...
  if (
    isTRUE(
      !is.empty(object@tot_inertia) &
        length(object@tot_inertia) != 1
    )
  ) {
    msg <- paste0(
      "Length of tot_inertia is ",
  ...
  if (
    isTRUE(
      !is.empty(object@std_coords_rows) &
        nrow(object@std_coords_rows) != dim_rows
    )
  ) {
    msg <- paste0(
      "Nr. of rows in std_coords_rows is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of columns in std_coords_rows is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of rows in std_coords_cols is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of columns in std_coords_cols is ",
  ...
  if (
    isTRUE(
      !is.empty(object@prin_coords_rows) &
        nrow(object@prin_coords_rows) != dim_rows
    )
  ) {
    msg <- paste0(
      "Nr. of rows in prin_coords_rows is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of columns in prin_coords_rows is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of rows in prin_coords_cols is ",
  ...
  if (
    ...
    msg <- paste0(
      "Nr. of columns in prin_coords_cols is ",
  ...
  if (
    isTRUE(
      !is.empty(object@apl_rows) &
        nrow(object@apl_rows) != dim_rows
    )
  ) {
    msg <- paste0(
      "Nr. of rows in apl_rows is ",
  ...
  if (
    isTRUE(
      !is.empty(object@apl_cols) &
        nrow(object@apl_cols) != nrow(object@V)
    )
  ) {
    msg <- paste0(
      "Nr. of rows in apl_cols is ",
  ...
  if (
    isTRUE(
      !is.empty(object@APL_score) &
        ncol(object@APL_score) != 4
    )
  ) {
    msg <- paste0(
      "Nr. of columns in APL_score is ",
...
run_pca <- function(mat, dims, rm_zeros = TRUE, python = TRUE) {
  parameters <- list()
